...
class KeyboardAssembly:
    ...
    def balljoint_socket_anchorv2(self):
        ...
        disk = cylinder(h=anchor_h, d=anchor_d, center=True)
        return translate(0, 0, -10)(disk)
    
    def transform_balljoint_socketv2(self, geom):
    ...
    def balljoint_socket_slitv2(self):
        """ 
        Does not remove web geometry if not called on it's own, does the same thing as the socket_slit above, man i suck at this
        """
        if self.connector_mount_enabled:
    ...
    def finger_balljointv2(self):
        ...
        if self.connector_mount_enabled:
            ...
            balljointv2 = (
                hull()(
                self.transform_balljoint_socketv2(self.balljoint_socket_anchorv2()),
                self.finger_layout.web_corner(0, 0, left=True, top=False),
        ...
        return (
            self.finger_part()
            + balljointv2
            + self.transform_balljoint_socketv2(self.balljoint_socket_v2())
            + self.transform_balljoint_socketv2(self.balljoint_socket_screwblock())
